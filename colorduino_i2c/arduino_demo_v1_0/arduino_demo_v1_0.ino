...
void update_display(byte addr) {
  ...
  Serial.print("update_display: ");
  Serial.print(addr, HEX);
  Serial.println(", ");
  /*Serial.print(display_byte[0], BIN);
  Serial.print(", ");
  Serial.print(display_byte[1], BIN);
  Serial.print(", ");
  Serial.println(display_byte[2], BIN);*/
...
static byte BlinkM_sendBuffer(byte addr, byte col, byte* disp_data) {
  Serial.print("BlinkM_sendBuffer: ");
  Serial.print(col, HEX);
  Serial.println(", ");
  Serial.print(*disp_data, HEX);
  Serial.println(", ");
