...
#define END_OF_DATA 0x20         //d ata markers
#define DEST_I2C_ADDR_TL 5       // top left set destination I2C address
#define DEST_I2C_ADDR_TR 6       // top right set destination I2C address
#define DEST_I2C_ADDR_BL 7       // top left set destination I2C address
#define DEST_I2C_ADDR_BR 8       // top left set destination I2C address

#define SCREENSIZEX 16           // num of LEDs accross
#define SCREENSIZEY 16           // num of LEDs down
int light = 0;
byte display_byte[3][256];        // display array - 64 bytes x 3 colours 
...
void plasma_morph()
{
  ...
  for(x = 0; x <SCREENSIZEX; x++) {
    for(y = 0; y < SCREENSIZEY; y++)
      {
	light=map(analogRead(0),0,1023,0,255);
